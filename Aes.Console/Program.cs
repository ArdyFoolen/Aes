...
namespace Aes.App
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (Stream writer = new FileStream("EncryptedFile.txt", FileMode.Create))
            ...
            using (Stream writer = new FileStream("DecryptedFile.txt", FileMode.Create))
            ...
            using (Stream stream = new FileStream("UnencryptedFile.txt", FileMode.Open))
            using (Stream writer = new FileStream("EncryptedCBCFile.txt", FileMode.Create))
            ...
            using (Stream writer = new FileStream("DecryptedCBCFile.txt", FileMode.Create))
            ...
            using (Stream stream = new FileStream("UnencryptedFile.txt", FileMode.Open))
            using (Stream writer = new FileStream("EncryptedCTRFile.txt", FileMode.Create))
            ...
            using (Stream writer = new FileStream("DecryptedCTRFile.txt", FileMode.Create))
            ...
            using (Stream stream = new FileStream("UnencryptedFile.txt", FileMode.Open))
            using (Stream writer = new FileStream("EncryptedGCMFile.txt", FileMode.Create))
            ...
            using (Stream writer = new FileStream("DecryptedGCMFile.txt", FileMode.Create))
