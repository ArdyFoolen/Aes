    ...
    public static class AesSourceHelper
    {
        ...
        public static IEnumerable<(byte[] In, byte[] Out, Action<Aes.AF.Aes, Stream, Stream> Crypt)> EncryptDecrypt
        {
            get
            {
                ...
                yield return (plainBytes, cryptBytes, (aes, outStream, inStream) => Encrypt(aes, key128, AesKeySize.Aes128, outStream, inStream));
                yield return (cryptBytes, plainBytes, (aes, outStream, inStream) => Decrypt(aes, key128, AesKeySize.Aes128, outStream, inStream));
                ...
                yield return (plainBytes, cryptBytes, (aes, outStream, inStream) => Encrypt(aes, key192, AesKeySize.Aes192, outStream, inStream));
                yield return (cryptBytes, plainBytes, (aes, outStream, inStream) => Decrypt(aes, key192, AesKeySize.Aes192, outStream, inStream));
                ...
                yield return (plainBytes, cryptBytes, (aes, outStream, inStream) => Encrypt(aes, key256, AesKeySize.Aes256, outStream, inStream));
                yield return (cryptBytes, plainBytes, (aes, outStream, inStream) => Decrypt(aes, key256, AesKeySize.Aes256, outStream, inStream));
            }
        }
